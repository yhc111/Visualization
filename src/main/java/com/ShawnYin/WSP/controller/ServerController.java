...
import com.ShawnYin.WSP.service.ServerService;
import com.ShawnYin.WSP.utils.ComputerMonitorUtil;
...
public class ServerController {
    ...
    @ResponseBody
    private Map<String, Object> GetDevice() throws Exception {
...
//        return new ResponseEntity<>(server, HttpStatus.OK);
    ...
    @RequestMapping("getDevice2")
    private ResponseEntity<Server> GetDevice2() throws Exception {

        System.out.println("次函数功能是获取设备的CPU,内存和磁盘数据");
        System.out.println("被访问的函数的名称：getDevice2");
